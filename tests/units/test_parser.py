...
def test_public_api_exports_parser_only():
    ...
    assert jsonweir.IncrementalJsonParser is IncrementalJsonParser
    assert not hasattr(jsonweir, "StartObject")
    assert not hasattr(jsonweir, "JsonParseError")
